    ...
    <>
      <Container>
        <Box m={10} textAlign={'center'}>
          <Box>
            <Typography fontWeight="700" color="#373b4a" variant="h3">
              Sorry, page not found!
            </Typography>
            <Typography fontSize={16} color="#373b4a" mt={2} variant="body1">
          ...
          <div className="wrapper">
            <svg width="70%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
